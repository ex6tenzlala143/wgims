...
class EngasTotalBreakdownTest extends TestCase
{
    ...
    public function test_cumulative_engas_sums_each_shipment_qty_times_its_own_engas_cost(): void
    {
        ...
        // Full delivery breakdown (Shipment Records) stays consistent too.
        $shipStart = strpos($html, 'Shipment Records');
        $shipments = substr($html, $shipStart);
        $this->assertStringContainsString('3,399,784.33', $shipments);
        $this->assertStringContainsString('304,800.00', $shipments);
    }
