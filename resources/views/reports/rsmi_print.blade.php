...
<div class="toolbar">
    ...
    <a class="btn-back" href="{{ route('rsmi_report', request()->query()) }}" onclick="if(history.length>1 && document.referrer && new URL(document.referrer).origin===location.origin){ history.back(); return false; }">← Back to RSMI</a>
